...
- Generate the UI through a **design agent** (Claude Design, v0, Figma AI, etc.). Do **not** drop in a ready-made theme/UI kit. Headless primitives are fine as building blocks.
